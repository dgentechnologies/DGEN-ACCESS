  ...
  return (
    <div className="space-y-8">
      ...
      <div>
        ...
        <p className="text-dark-400">Welcome to DGEN Access Control System</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        {statCards.map((stat, index) => (
          <motion.div
            ...
            className="bg-dark-900 rounded-xl border border-dark-700 p-6 hover:border-primary-500 transition-all duration-300"
          >
      ...
      <div className="bg-dark-900 rounded-xl border border-dark-700 p-6">
        ...
        <div className="space-y-3">
          ...
          <div className="flex items-center justify-between">
            <span className="text-dark-400">Firebase Connection</span>
            <span className="flex items-center text-green-500">
              <span className="w-2 h-2 bg-green-500 rounded-full mr-2 animate-pulse"></span>
              Connected
            </span>
      ...
      <div className="bg-gradient-to-br from-primary-500 to-primary-600 rounded-xl p-6 text-white">
        ...
        <div className="bg-white/10 rounded-lg p-4 font-mono text-sm">
          POST {window.location.origin}/verify
        </div>
      </div>
    </div>
  );
