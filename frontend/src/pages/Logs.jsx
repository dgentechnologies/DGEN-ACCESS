    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-dark-400">Monitor all access attempts in real-time</p>
        </div>
      ...
      <div className="bg-dark-900 rounded-xl border border-dark-700 overflow-hidden">
        {logs.length === 0 ? (
          <div className="p-12 text-center">
            ...
            <p className="text-dark-400">No access logs yet</p>
          </div>
        ) : (
          <div className="divide-y divide-dark-700 max-h-[calc(100vh-300px)] overflow-y-auto">
            {logs.map((log, index) => (
              <motion.div
                key={log.id || index}
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-dark-400 font-mono">{log.id}</p>
                    </div>
                  </div>
                  <div className="text-right">
                    ...
                    <p className="text-xs text-dark-400">{log.time}</p>
                  </div>
                </div>
              </motion.div>
            ))}
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="bg-dark-900 rounded-xl border border-dark-700 p-6">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-dark-400 text-sm mb-1">Total Attempts</p>
        ...
        <div className="bg-dark-900 rounded-xl border border-dark-700 p-6">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-dark-400 text-sm mb-1">Access Granted</p>
        ...
        <div className="bg-dark-900 rounded-xl border border-dark-700 p-6">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-dark-400 text-sm mb-1">Access Denied</p>
